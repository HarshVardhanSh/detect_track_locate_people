...
flags.DEFINE_integer('room_size', 10, 'size of the square room in feet')
...
def main(_argv):
    ...
    quad_coords = {
    "target": np.array([
        [FLAGS.room_size, 0], #top right
        [0, 0], # top left
        [0, FLAGS.room_size], # bottom left
        [FLAGS.room_size, FLAGS.room_size] #  bottom right
    ]),
    "source": np.array([
        [1900, 10], # top right
        [920, 100], #  top left
        [0, 520], #  bottom left
        [1710, 1060] # bottom right
    ])}
    ...
    while True:
        ...
        # cv2.circle(img, (0, 520 ), 5, (0, 0, 0), 10) #bottom left (0, 10)
        # cv2.circle(img, (920, 100), 5, (250, 0, 0), 10) #top left (0, 0)
        # cv2.circle(img, (1710, 1060), 5, (0, 255, 0), 10) #bottom right (10, 10)
        # cv2.circle(img, (1900, 10), 5, (0, 0, 255), 10) #top right (10, 0)
        ...
        for track in tracker.tracks:
            ...
            cv2.putText(track_pad, class_name + "-" + str(track.track_id),(centroid_x, centroid_y-20),0, 0.75, (0, 0, 0), 2)
